...
namespace WebApi.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            kernel.Bind<LicensingContext>().ToSelf();
            ...
            kernel.Bind<IProductFamilyRepository>().To<ProductFamilyRepository>();
            kernel.Bind<IActivationRepository>().To<ActivationRepository>();
            kernel.Bind<IApplicationRepository>().To<ApplicationRepository>();
            kernel.Bind<ILicenseLookUp>().To<LicenseLookUp>();
        }        
    }
}
